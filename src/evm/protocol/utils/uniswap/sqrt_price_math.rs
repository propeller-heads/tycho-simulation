...
mod tests {
    ...
    fn test_get_amount0_delta(
        ...
        let res = get_amount0_delta(a, b, U256::from(liquidity), round_up).unwrap();
        assert_eq!(res, exp);
    }
    ...
    fn test_get_amount1_delta(
        ...
        let res = get_amount1_delta(a, b, U256::from(liquidity), round_up).unwrap();
        assert_eq!(res, exp);
    }
    ...
    fn test_get_next_sqrt_price_from_input(
        ...
        let res = get_next_sqrt_price_from_input(
            sqrt_price,
            U256::from(liquidity),
            amount_in,
            zero_for_one,
    ...
    fn test_get_next_sqrt_price_from_output(
        ...
        let res = get_next_sqrt_price_from_output(
            sqrt_price,
            U256::from(liquidity),
            amount_in,
            zero_for_one,
