...
mod tests {
    ...
    #[test]
    #[ignore] // TODO: Fix validation for unreachable targets in V4
    ...
    #[test]
    #[ignore] // TODO: Fix amount matching between swap_to_trade_price and swap
    fn test_swap_to_trade_price_verifies_trade_price() {
        ...
        assert_eq!(
            ...
            "swap_to_trade_price's amount_out should match actual swap result"
        );
    }

    #[test]
    #[ignore] // TODO: Fix tolerance between swap_to_trade_price and get_amount_out
    fn test_swap_to_trade_price_matches_get_amount_out() {
        ...
        assert!(
            relative_diff < 0.001,
            "Difference between swap_to_trade_price and get_amount_out should be less than 0.1%"
        );
    }
}
